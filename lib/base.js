(function (window) {
    ...
    class Td {
        ...
        static content(value, classname) {
            ...
            let content = contnet_value instanceof HTMLElement ? contnet_value : document.createTextNode(contnet_value.toString());
    ...
    class Thead {
        ...
        addRow() {
            arguments.__proto__ = Array.prototype;
            let elements = Td.parse.apply(this, arguments);
            if (elements.length === 0) return null;

            let tr = new Tr(this);
            for (let item = 0; item < elements.length; item++)
                tr.addColumn(Th, elements[item]);
        ...
        drop(all) {
            ...
            for (let item = 0; item < rows.length; item++)
                Table.removeElementDOM(rows[item].out());
            ...
            Table.removeElementDOM(this.out());
            delete table.thead;
    ...
    class Table {
        ...
        getColgroup() {
            ...
            let table = this.getTable();
            this.elements.colgroup = new Colgroup(this);
        ...
        getThead() {
            ...
            this.elements.thead = new Thead(this);
        ...
        getTbody() {
            ...
            this.elements.tbody = new Tbody(this);
        ...
        getTfoot() {
            ...
            this.getTbody();
            this.elements.tfoot = new Tfoot(this);
